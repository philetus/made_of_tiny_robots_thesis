...
\begin{figure}[b!]
  \centering
    \includegraphics[width=130mm]{popsicle_ecosystem.pdf}
...
\begin{figure}[b!]
  \centering
    \includegraphics[width=130mm]{spoke_ecosystem.pdf}
...
\begin{figure}[b!]
  \centering
    \includegraphics[width=\textwidth]{robunculi_ecosystem.pdf}
